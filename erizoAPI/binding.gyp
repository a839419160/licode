{
  'variables' : {
    'common_sources': [ 'addon.cc', 'IOThreadPool.cc', 'ThreadPool.cc', 'MediaStream.cc', 'WebRtcConnection.cc', 'OneToManyProcessor.cc', 'ExternalInput.cc', 'ExternalOutput.cc', 'SyntheticInput.cc', 'ConnectionDescription.cc'],
    ...
    'target_name': 'addon',
      ...
      'conditions': [
        [ 'OS=="mac"', {
          ...
          'cflags_cc' : ['-Wall', '-O3', '-g' , '-std=c++11', '-fexceptions', '-DASIO_STANDALONE', '-Wno-deprecated-declarations'],
